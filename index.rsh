...
export const main = Reach.App(() => {
  ...
  const CREATOR = Participant('CREATOR', {
    ...
    notify    : Fun([Token,UInt,UInt], Null),
    soldOut   : Fun([Token,Contract],Null),
    ready     : Fun([Token,Contract],Null),
    end       : Fun([],Null)
  });
